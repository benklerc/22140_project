...
PCA does not seem to capture healthy/parkinsons.
...
```{r}
saveRDS(dds_gender_08, file = "../data/deseq2_results_08.rds")
saveRDS(res_gender_08, file = "../data/deseq2_object_08.rds")

saveRDS(dds_gender_age_08, file = "../data/deseq2_results_08_age.rds")
saveRDS(res_gender_age_08, file = "../data/deseq2_object_08_age.rds")
```

Conclusion: age is not a confounder! (actually only introduces more bias?)
