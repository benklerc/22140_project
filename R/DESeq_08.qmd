...
```{r}
res_gender_age_08 <- results(dds_gender_08,
                         contrast =c(
                          "groups",
                          "healthy",
                          "parkinson's")
...
cat("number of significant genes when modelling with gender:", n_sig_gender_age_08, "\n")
...
```{r}
saveRDS(dds_gender_age_08, file = "../data/deseq2_results_08.rds")
saveRDS(res_gender_age_08, file = "../data/deseq2_object_08.rds")
```
