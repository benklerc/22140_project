...
MA_77 <- plotMA(res_77, ylim=c(-2,2))

```

```{r}
ggsave("../fig/MA_77.png", plot = MA_77)
png(filename = "../fig/MA_77.png")
...
cat("number of significant genes when modelling with gender and age:", n_sig_gender_age_77, "\n")
