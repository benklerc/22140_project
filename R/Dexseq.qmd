...
isoform_count_08 <- filter_low_expression(isoform_count_08, threshold = 1000)
isoform_count_77 <- filter_low_expression(isoform_count_77, threshold = 1000)
...
saveRDS(dxdResult, file = "../data/dexseq_results.rds")
saveRDS(dxdSubset, file = "../data/dexseq_dataset_object.rds")
